...
type NewsRow = {
  ...
  origin_type: NewsArticle["originType"] | null; technical_source_label: string | null; technical_source_locator: string | null; technical_source_report_number: string | null; evidence_ids: string[] | null;
};
