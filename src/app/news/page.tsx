...
export async function generateMetadata({ searchParams }: NewsPageProps) {
  ...
  return createPageMetadata({ title: page > 1 ? `Aerogel Industry News - Page ${page} | Cowin Materials` : "Aerogel Industry News and Technical Insights | Cowin Materials", description: "Source-linked industry briefs on silica aerogel insulation, battery thermal barriers, fire protection coatings and waterproofing material trends.", path: page > 1 ? `/news?page=${page}` : "/news", keywords: ["aerogel news", "silica aerogel insulation", "battery thermal barrier news"] });
}
