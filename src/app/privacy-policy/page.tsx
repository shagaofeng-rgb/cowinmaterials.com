    ...
    <>
      ...
      <main>
        ...
        <section className="section legal-copy">
          ...
          <h2>Sharing</h2>
          <p>Our Contact and Locations pages embed Google Maps. When a map loads, your browser connects to Google, which may receive your IP address and browser information. Google handles this information under its <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>.</p>
