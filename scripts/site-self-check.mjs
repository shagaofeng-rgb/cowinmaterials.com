...
for (const item of ["Quzhou Qiying Import & Export Co., Ltd.", "info@cowinmaterials.com", "+86 176 0125 2505", "officeAddress", "aerogel-powders-granules", "fireproof-waterproof-solutions"]) assert.ok(data.includes(item), `Missing official site datum: ${item}`);
